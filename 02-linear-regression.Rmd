...
```{r esl-lsr-quote, fig.cap='Exerpt from Elements of Satistical Learning', out.width='80%', fig.align='center', fig.alt='Exerpt of page 52 of Elements of Statistical Learning.', echo = FALSE}
knitr::include_graphics("img/esl_screenshot.png")
```
