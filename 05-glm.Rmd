...
```{r exp-fam-ET-1, fig.cap='Derivation of $E[T(Y)]$.', out.width='80%', fig.align='center', fig.alt='Derivation of $E[T(Y)]$.', echo = FALSE}
knitr::include_graphics("img/05-glm/exp_fam_ET.png")
```  

If I try to prove it, I find myself with the derivative of $\eta$ surviving:

```{r exp-fam-ET-2, fig.cap='Alternative derivation of $E[T(Y)]$.', out.width='80%', fig.align='center', fig.alt='Alternative derivation of $E[T(Y)]$.', echo = FALSE}
knitr::include_graphics("img/05-glm/exp_fam_ET_2.png")
``` 
